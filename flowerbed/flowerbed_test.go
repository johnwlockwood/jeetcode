...
func TestCanPlaceFlowersSinglePass(t *testing.T) {
	type test struct {
		flowerbed []int
		flowers   int
		want      bool
	...
	for _, tc := range tests {
		if got := canPlaceFlowersSinglePass(tc.flowerbed, tc.flowers); got != tc.want {
			t.Errorf("placing %d flowers in %v bed: got %v, want %v", tc.flowers, tc.flowerbed, got, tc.want)
		}
	}
}

func TestCanPlaceFlowersNoChanges(t *testing.T) {
	type test struct {
		flowerbed []int
		flowers   int
		want      bool
	...
	for _, tc := range tests {
		if got := canPlaceFlowersNoChanges(tc.flowerbed, tc.flowers); got != tc.want {
			t.Errorf("placing %d flowers in %v bed: got %v, want %v", tc.flowers, tc.flowerbed, got, tc.want)
		}
	}
}
